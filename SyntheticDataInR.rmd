...
The `rpp` function is used to synthesise point process based on the HPP and IHPP models, while the ` rpcp` function is used to synthesise point process based on the PCP model. In this exercise, the point processes are generated within a 3D region defined spatially by the geographical boundary of South Chicago, and temporally by one year time interval i.e.
